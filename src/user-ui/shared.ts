...
export interface ArticleSummaryResult {
  ...
  reason?: 'fulltext_missing' | 'evidence_v2_required' | 'summary_pending' | 'summary_not_reviewed' | 'summary_stale' | 'summary_invalid' | 'ai_unavailable';
  source?: 'fulltext' | 'reviewed_evidence_v2';
  cached?: boolean;
  zh?: string;
  en?: string;
  generatedAt?: number;
