...
console.log('TM229_DOMAIN_TEST_SUMMARY '+JSON.stringify({passed,captureProtocol:'6.2.20',controllerRevision:'2.2.33',primaryGallery:'https://gallery.gczhouwld.com/'}));
