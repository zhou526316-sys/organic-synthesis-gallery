...
ASSET_RE = re.compile(r"^audit/media-recovery/body-batches/assets/([a-f0-9]{64})\.(svg|png|webp|jpe?g)$")
R2_RE = re.compile(r"^local-captures/article-figures/images/[a-f0-9]{24}/(?:figure|scheme|chart)-\d+-([a-f0-9]{16})\.(svg|png|webp|jpe?g)$")
