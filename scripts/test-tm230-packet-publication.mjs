...
const report=(row,labels=[row.label],extra={})=>({doi:row.doi,jobId:row.jobId,captureVersion:'6.2.20',controllerRevision:'2.2.34',mediaNeed:'toc+figures',final:true,status:'success',figuresDiscovered:labels.length,figuresStored:labels.length,figureLabels:labels,...extra});
