...
if 'BEGIN OSG_UPLOAD_EVIDENCE_V1' not in s:
 ...
 s=s[:a]+f+s[b:]
 save(p,s)
else:assert any("var CONTROLLER_REVISION = '"+v+"';" in s for v in ('2.2.23','2.2.24','2.2.25','2.2.26','2.2.27','2.2.28','2.2.29','2.2.30','2.2.31','2.2.32','2.2.33','2.2.34','2.2.35','2.2.36'))
